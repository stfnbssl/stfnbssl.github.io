/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\stfnbssl.github.io\philos\.wizzi\ittf\examples\index.js.ittf
*/
'use strict';
/**
...
function executeGenerateModules(modules, callback) {
    async.mapSeries(modules, (module, callback) => {
        var ittfDocumentUri = path.join(__dirname, 'ittf', module + '.philos.ittf');
        var outputPath = path.join(__dirname, '..', '..', module + '.philos');
