/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\stfnbssl.github.io\guidedb\.wizzi\ittf\client\src\components\auth\RegisterForm.js.ittf
*/
'use strict';
            ...
            <form className={classes.container} onSubmit={onSubmit}>
                ...
                <Button onClick={onSubmit} variant="outlined" color="primary" fullWidth className={classes.button} disabled={!isFormEnabled} type="submit">
                {
                    isLoading ?  (
                     ...
                     : 'Sign up for demo-mern'
                }</Button>
            
                <p className={classes.little}>
                By clicking “Sign up for demo-mern”, you agree to our &nbsp;<a href="/help/terms">
                    terms of service
                    </a>
